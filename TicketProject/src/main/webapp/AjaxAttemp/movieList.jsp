...
<c:choose>
  ...
  <table class="table table-hover">
    ...
    <c:forEach items="${movies}" var="m">
      <tr>
        <td style="width: 50%;"><button type="submit" class="btn btn-default" name="movieId" data-toggle="modal" data-target="#myMovieModal" onclick="openMovie(${m.movieId})"><c:out value='${m.name}'/></button></td>
...
<!-- Modal -->
<div class="modal fade bs-example-modal-lg" id="myMovieModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
